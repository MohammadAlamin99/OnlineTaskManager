                      ...
                      ? getTodo.map((item, i) => {
                          return (
                            <div key={i} className="taxbox">
                              ...
                              <h4
                                style={{ color: "#08A9F4", fontWeight: "600" }}
                              >
                                {item.status}
                              </h4>
                              <h4>
                                Due Date : {moment(item.dueDate).format("ll")}
                              </h4>
                      ...
                      ? getInPro.map((item, i) => {
                          return (
                            <div key={i} className="taxbox">
                              ...
                              <h5>{item.description}</h5>
                              <h4
                                style={{ color: "#FF7800", fontWeight: "600" }}
                              >
                                {item.status}
                              </h4>
                              <h4>
                      ...
                      ? getComplete.map((item, i) => {
                          return (
                            <div key={i} className="taxbox">
                              ...
                              <h5>{item.description}</h5>
                              <h4
                                style={{ color: "#2ECD6E", fontWeight: "600" }}
                              >
                                {item.status}
                              </h4>
                              <h4>
                  ...
                  <div className="card-container">
                    <div className="task-card">
                      <div className="tag-wrapper d-flex align-items-center gap-2">
                        ...
                        <div className="tag">High Priority</div>
                      </div>
                      ...
                      <p className="task-description">
                        ...
                        adipisicing elit. Eum quaerat eius hic velit ipsum voluptates. Eveniet asperiores quam animi, minima perferendis eum ut consectetur sequi officiis veritatis quaerat ab. Fugiat.
                      </p>
                      <h5 className="task-date">Aug 20, 2021</h5>
